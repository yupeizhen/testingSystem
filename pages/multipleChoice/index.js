...
Page({
  ...
  data: {
    ...
    currentTab: 0,
    // 利息、股息、红利赋值START
    securityHoldingTime: "onemonth",
    securityHoldingTimeSet: [
      { name: 'onemonth', value: "持股一个月内", checked: 'true' },
      { name: 'oneyear', value: "持股一个月至一年", },
      { name: 'oneyearplus', value: "持股一年以上", },
      { name: 'oneyearplus', value: "持股一年以上"},
    ],
    opitionTextA:'',
    opitionTextB:'',
    ...
    // 利息、股息、红利赋值END
    // 财产转让赋值START
    transferOfPropertyTypeSet: [
      { name: 'securityproperty', value: "股票转让", },
      { name: 'quantproperty', value: "量化资产转让", },
      { name: 'generalproperty', value: "一般财产转让",},
      { name: 'xxx', value: "一财产转让", },
    ],
    question: [
